...
export function initializeState(polytopeManifest) {
	...
	// This also calls the setupParameterControls
	setPolytope(name, params = undefined) {
	    const builder = this.polytopeManifest[name];
	    this.currentBuilder = builder;

	    // If param values are provided, pass them to the builder
